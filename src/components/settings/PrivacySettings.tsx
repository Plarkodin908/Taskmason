      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch checked={preferences.publicProfile} onCheckedChange={checked => onPreferenceChange("publicProfile", checked)} className="text-violet-400" />
          </div>
          <div className="flex items-center justify-between">
            <div>
            ...
            <Switch checked={preferences.showActivity} onCheckedChange={checked => onPreferenceChange("showActivity", checked)} className="text-violet-400" />
          </div>
        </div>
      </div>
    </div>;
